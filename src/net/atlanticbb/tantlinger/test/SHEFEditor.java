 ...
 */
package net.atlanticbb.tantlinger.test;
 ...
 *
 */
public class SHEFEditor extends JFrame
{    
    /**
     * 
     */
    ...
    private static final I18n i18n = I18n.getInstance("net.atlanticbb.tantlinger.test");
    ...
    private void createEditorActions()
    {
        ...
        //create insert menu
        JMenu insertMenu = new JMenu(i18n.str("insert"));
    ...
    private JEditorPane createWysiwygEditor()
    {
        ...
        ed.setBackground(Color.white);//gtk it looks weird
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            {                
                ...
                if(fontFamilyCombo.getSelectedIndex() != 0)
                {
                    ...
                    //HTMLUtils.setCharacterAttributes(focusedEditor, tagAttrs);
                }
                else
                {
                    HTMLUtils.setFontFamily(wysEditor, null);
                    //HTMLUtils.removeCharacterAttribute(focusedEditor, StyleConstants.FontFamily);
                    //font data in HTMLDocs are stored with the CSS.Attribute.FONT* attrib
                    //HTMLUtils.removeCharacterAttribute(focusedEditor, CSS.Attribute.FONT_FAMILY);                                        
                }
