...
public class Entities
{
    ...
    // <!-- Latin Extended-B -->
        ...
        // <!-- alef symbol is NOT the same as hebrew letter alef,U+05D0 although the same glyph could be used to depict
        // both characters -->
        // <!-- Arrows -->
        ...
        // <!-- ISO 10646 does not say that lArr is the same as the 'is implied by' arrowbut also does not have any
        // other character for that function. So ? lArr canbe used for 'is implied by' as ISOtech suggests -->
        {"uArr", "8657"}, // upwards double arrow, U+21D1 ISOamsa -->
        {"rArr", "8658"}, // rightwards double arrow,U+21D2 ISOtech -->
        // <!-- ISO 10646 does not say this is the 'implies' character but does not have another character with this
        // function so ?rArr can be used for 'implies' as ISOtech suggests -->
        ...
        // <!-- prod is NOT the same character as U+03A0 'greek capital letter pi' though the same glyph might be used
        // for both -->
        {"sum", "8721"}, // n-ary summation, U+2211 ISOamsb -->
        // <!-- sum is NOT the same character as U+03A3 'greek capital letter sigma' though the same glyph might be used
        // for both -->
        ...
        // <!-- tilde operator is NOT the same character as the tilde, U+007E,although the same glyph might be used to
        // represent both -->
        ...
        // <!-- note that nsup, 'not a superset of, U+2283' is not covered by the Symbol font encoding and is not
        // included. Should it be, for symmetry?It is in ISOamsn --> <!ENTITY nsub", "8836"}, //not a subset of, U+2284
        // ISOamsn -->
    ...
    static
    {
        ...
        HTML40_FULL.addEntities(ISO8859_1_ARRAY);
        HTML40_FULL.addEntities(HTML40_ARRAY);
